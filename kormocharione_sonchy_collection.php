      ...
      <!--------------------------
        ...
        <form action="" method="post" name="">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><a href="kormocharione_sonchycollection_report.php" class="btn btn-success" role="button">সঞ্চয় কালেকশন রিপোর্ট</a></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <table id="kormionesontable" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>তারিখ</th>
                            <th>গ্রাহকের হিসাব</th>
                            <th>রেজিস্ট্রেশন নম্বর</th>
                            <th>গ্রাহকের নাম</th>
                            <th>গ্রাহকের মোবাইল নং</th>
