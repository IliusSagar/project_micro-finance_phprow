...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      কর্মচারী ১ | ঋন রেজিস্ট্রেশন ফর্ম 
        <small></small>
      </h1>
      <ol class="breadcrumb">
      ...
      <!--------------------------
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><a href="kormocharione_rinreg_report.php" class="btn btn-success" role="button">ঋন রেজিস্ট্রেশন রিপোর্ট</a></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form action="" method="post" name="kormione_form_name" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label >ঋন রেজিস্ট্রেশন নম্বর</label>
